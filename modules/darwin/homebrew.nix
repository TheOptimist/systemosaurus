...
# Lifted directly from https://github.com/malob/nixpkgs/blob/master/darwin/modules/homebrew.nix
# Pull request to nix-darwin is https://github.com/LnL7/nix-darwin/pull/262
# The thread is interesting and the author of nix-darwin raises a good point
# about compatibility. Still, going with this for the moment.
with lib;
